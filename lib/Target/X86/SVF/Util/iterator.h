...
#include "SVF/Util/iterator_range.h"
#include <cstddef>
#include <iterator>
#include <type_traits>
#include <utility>
...
template <
  ...
  typename PointerT = conditional_t<
        std::is_same<T, typename std::iterator_traits<
                         WrappedIteratorT>::value_type>::value,
        typename std::iterator_traits<WrappedIteratorT>::pointer, T *>,
  typename ReferenceT = conditional_t<
        std::is_same<T, typename std::iterator_traits<
                         WrappedIteratorT>::value_type>::value,
...
template <typename WrappedIteratorT,
          typename T = remove_reference_t<decltype(
...
template <typename WrappedIteratorT,
          typename T1 = remove_reference_t<decltype(
                      **std::declval<WrappedIteratorT>())>,
          typename T2 = add_pointer_t<T1>>
