...
template <typename T>
struct add_const_past_pointer<T, enable_if_t<std::is_pointer<T>::value>>
{
...
struct isa_impl<To, From, enable_if_t<std::is_base_of<To, From>::value>>
{
...
inline enable_if_t<!is_simple_type<Y>::value,
...
template <class X, class Y>
LLVM_NODISCARD inline enable_if_t<
