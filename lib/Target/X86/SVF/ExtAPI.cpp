...
ExtAPI* ExtAPI::getExtAPI(const std::string& path)
{
	...
	// Hacked to check /install_root/lib/ExtAPI.json first, and config.h hacked to have /TASE/lib/ExtAPI.json
	
        std::string jsonFilePath = "/install_root/lib/ExtAPI.json";
