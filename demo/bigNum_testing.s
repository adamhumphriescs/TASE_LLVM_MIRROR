...
.LBB5_2_CartridgeBody:
	...
	movzbl	(%rdi,%rcx), %r8d       # Instruction is Tainted 
	leaq	(%rsi,%rcx), %r14
	shrq	%r14
	pinsrw	$1, (%r14,%r14), %xmm15
	movzbl	(%rsi,%rcx), %r9d       # Instruction is Tainted 
	addl	%r8d, %eax              # Instruction is Tainted 
	addl	%r9d, %eax              # Instruction is Tainted 
	leaq	(%rdx,%rcx), %r14
	shrq	%r14
	pinsrw	$2, (%r14,%r14), %xmm15
	movb	%al, (%rdx,%rcx)        # Instruction is Tainted 
	movzbl	%ah, %eax               # Instruction is Tainted 
	addq	$1, %rcx
